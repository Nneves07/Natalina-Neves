...
import HolographicParticles from "../ui/HolographicParticles";
...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen relative overflow-hidden bg-black text-white pt-24">
      ...
      {/* Holographic Particles - UNIQUE & MEMORABLE */}
      <HolographicParticles />
      
      {/* Holographic 3D Text Background */}
      <motion.div
      ...
      >
        <div className="text-[20rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400/20 via-purple-400/20 to-pink-400/20 select-none">
          AI
        </div>
      </motion.div>
